...
from util.constants import PartialOrderMode, SKIP, TIMEOUT, SearchAlgorithms
...
header = ['variant', 'trace_idx', 'trace_length', 'time_taken', 'time_taken_potext', 'queued_events', 'visited_events',
          'alignment_costs']
...
timeout_duration = TIMEOUT  # Adjust as needed
...
def process_trace(trace_idx, trace, model_net, model_im, model_fm):
    try:
        ...
        a = compute_alignments_for_sync_product_net(sync_prod, sync_im, sync_fm,
